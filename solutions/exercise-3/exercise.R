...
cat("spent on personal care in 1940:", care.1940, "\n")
...
highest.1960 <- us.exp$category[which.max(us.exp$X1960)]
cat("highest category in 1960:", highest.1960, "\n")
...
cat("highest category in 1950:", highest.1950, "\n")
